...
MaTi <- read.csv('Sara_SarahSarahEatenByWolves.csv', header=TRUE, sep=',', na.strings=c('','NA'))
...
Table3 <- Added[split2:(length(Added$Round)),]
...
write.csv(Table8, 'SarahWolfEaten_addedFeatures.csv', row.names=F)
